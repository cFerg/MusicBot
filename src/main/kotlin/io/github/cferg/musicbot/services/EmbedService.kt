...
class EmbedService(private val discord: Discord) {
    fun trackDisplay(guild: Guild, audioPlayerService: AudioPlayerService): MessageEmbed {
        val songList = audioPlayerService.fetchUpcomingSongs(guild)
        val isPlaying = audioPlayerService.isTrackPlaying(guild)
    ...
    private fun formatSong(song: AudioPlayerService.Song, guild: Guild, header: String = "- **Song**:"): String {
